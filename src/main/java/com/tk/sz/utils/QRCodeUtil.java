...
public class QRCodeUtil {
	...
	private static void insertImage(BufferedImage source, String imgPath,
		...
		RoundRectangle2D shape = new RoundRectangle2D.Float(x, y, width, width,
				6, 6);
	...
	public static void main(String[] args) throws Exception {
		 ...
		 String imagePath = "D:/workspace/app1/src/main/resources/image/logo.png";
		 String destPath = "D:/workspace/app1/src/main/resources/image/";
		 QRCodeUtil.encode(text, imagePath, destPath, true , "123.jpg");
